...
public class ServicioFirma {
     ...
     */
    public String firmaAdjuntaPKCS7(String artifact, byte[] dataToSign) throws SWException {
        try {
            ...
            if (UtilesSWHelper.RESULTMAJOR_SUCCES_FIRMA.equals(sResp.getResultMajor())
                ...
                System.out.println("Resultado: " + sResp.getResultMajor());
                System.out.println("Resultado: " + sResp.getResultMinor());
                System.out.println("Msj: " + sResp.getResultMessage());
     ...
     * @return 
     * @throws com.isa.SW.exceptions.SWException 
     * @deprecated utilizar ServicioDSV
     */
    ...
    public boolean verificarXMLEnveloping(String artifact, String dataSigned) throws SWException {    
        try{
            ...
            System.out.println("Documento en base64: " + sResp.getDocumentBase64Data());
            System.out.println("DocumentXmlData: " + sResp.getDocumentXmlData());
            System.out.println("DocumentWithSignatureXml: " + sResp.getDocumentWithSignatureXml());           
            return ret;
        }
        catch(Exception ex){
            Logger.getLogger(ServicioKM.class.getName()).log(Level.SEVERE, null, ex);
